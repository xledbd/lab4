///////////////////////////////////////////////////////////////////////////////
//                                                                           //
//                LibXL Delphi 12 wrapper version 3.9.0                      //
//                                                                           //
...
function xlRichStringAddFont(handle: RichStringHandle): FontHandle cdecl;
...
type
  ...
  public
     ...
     function addFont(): TFont;
     procedure addText(const text: WideString); overload;
     procedure addText(const text: WideString; font: TFont); overload;
     function getText(index: Integer): WideString; overload;
     function getText(index: Integer; var font: TFont): WideString; overload;
...
type
  ...
  public
    ...
    function readStr(row: Integer; col: Integer; var format: TFormat): WideString; overload;
    function writeStr(row: Integer; col: Integer; value: PWideChar): boolean; overload;
    function writeStr(row: Integer; col: Integer; value: PWideChar; format: TFormat): boolean; overload;

    function readRichStr(row: Integer; col: Integer): TRichString; overload;
    function readRichStr(row: Integer; col: Integer; var format: TFormat): TRichString; overload;
    function writeRichStr(row: Integer; col: Integer; value: TRichString): boolean; overload;
    function writeRichStr(row: Integer; col: Integer; value: TRichString; format: TFormat): boolean; overload;
    ...
    function writeNum(row: Integer; col: Integer; value: double; format: TFormat): boolean; overload;
    ...
    function writeBool(row: Integer; col: Integer; value: boolean; format: TFormat): boolean; overload;

    function readBlank(row: Integer; col: Integer; var format: TFormat): boolean;
    function writeBlank(row: Integer; col: Integer; format: TFormat): boolean;

    function readFormula(row: Integer; col: Integer): WideString; overload;
    function readFormula(row: Integer; col: Integer; var format: TFormat): WideString; overload;
    function writeFormula(row: Integer; col: Integer; value: PWideChar): boolean; overload;
    function writeFormula(row: Integer; col: Integer; value: PWideChar; format: TFormat): boolean; overload;

    function writeFormulaNum(row: Integer; col: Integer; expr: PWideChar; value: double): boolean; overload;
    function writeFormulaNum(row: Integer; col: Integer; expr: PWideChar; value: double; format: TFormat): boolean; overload;

    function writeFormulaStr(row: Integer; col: Integer; expr: PWideChar; value: PWideChar): boolean; overload;
    function writeFormulaStr(row: Integer; col: Integer; expr: PWideChar; value: PWideChar; format: TFormat): boolean; overload;

    function writeFormulaBool(row: Integer; col: Integer; expr: PWideChar; value: Integer): boolean; overload;
    function writeFormulaBool(row: Integer; col: Integer; expr: PWideChar; value: Integer; format: TFormat): boolean; overload;
    ...
    function setCol(col: Integer; width: double; format: TFormat): boolean; overload;
    function setCol(colFirst, colLast: Integer; width: double; format: TFormat): boolean; overload;
    function setCol(col: Integer; width: double; format: TFormat; hidden: boolean): boolean; overload;
    function setCol(colFirst, colLast: Integer; width: double; format: TFormat; hidden: boolean): boolean; overload;

    function setRow(row: Integer; height: double): boolean; overload;
    function setRow(row: Integer; height: double; format: TFormat): boolean; overload;
    function setRow(row: Integer; height: double; format: TFormat; hidden: boolean): boolean; overload;
...
type
  ...
  public
    ...
    function addSheet(name: PWideChar): TSheet; overload;
    function addSheet(name: PWideChar; initSheet: TSheet): TSheet; overload;
    function insertSheet(index: Integer; name: PWideChar): TSheet; overload;
    function insertSheet(index: Integer; name: PWideChar; initSheet: TSheet): TSheet; overload;
    ...
    function addRichString(): TRichString;
    ...
    function setLocale(locale: PWideChar): boolean;
...
constructor TRichString.Create(handle: RichStringHandle; book: BookHandle);
begin
  inherited Create;
  self.book := book;
  self.handle := handle;
...
function TRichString.addFont(): TFont;
var
  fntHandle: FontHandle;
begin
  fntHandle := xlRichStringAddFont(handle);
...
procedure TRichString.addText(const text: PWideChar);
begin
   xlRichStringAddText(handle, text, nil);
end;

procedure TRichString.addText(const text: PWideChar; font: TFont);
begin
   xlRichStringAddText(handle, text, font.handle);
end;

function TRichString.getText(index: Integer): WideString;
var
   fntHandle: FontHandle;
begin
...
function TRichString.getText(index: Integer; var font: TFont): WideString;
var
   fntHandle: FontHandle;
   ret: WideString;
begin
   ...
   if fntHandle <> nil then
       font := TFont.Create(fntHandle, book);
   result := ret;
end;

function TRichString.textSize(): Integer;
begin
...
function TFilterColumn.filter(index: Integer): PWideChar;
begin
  result := xlFilterColumnFilter(handle, index);
end;

procedure TFilterColumn.addFilter(const value: PWideChar);
begin
...
function TFilterColumn.getCustomFilter(var op1: Operator; var v1: PWideChar; var op2: Operator; var v2: PWideChar; var andOp: boolean): boolean;
var
...
procedure TFilterColumn.setCustomFilter(op: Operator; const v: PWideChar);
begin
  xlFilterColumnSetCustomFilter(handle, Integer(op), v);
end;

procedure TFilterColumn.setCustomFilter(op1: Operator; const v1: PWideChar; op2: Operator; const v2: PWideChar; andOp: boolean);
begin
...
function TFont.GetName: WideString;
begin
...
function TSheet.ErrorMessage: WideString;
begin
...
function TSheet.readStr(row, col: Integer): WideString;
var
  format: FormatHandle;
  s: PWideChar;
begin
...
function TSheet.readStr(row, col: Integer; var format: TFormat): WideString;
var
...
function TSheet.writeStr(row, col: Integer; value: PWideChar): boolean;
begin
  result := xlSheetWriteStr(handle, row, col, value, nil) > 0;
end;

function TSheet.writeStr(row, col: Integer; value: PWideChar; format: TFormat): boolean;
begin
  result := xlSheetWriteStr(handle, row, col, value, format.handle) > 0;
end;

function TSheet.readRichStr(row: Integer; col: Integer): TRichString;
var
...
begin
  ...
  if richString <> nil then
    result := TRichString.Create(richString, handle)
  else
    result := nil;
end;

function TSheet.readRichStr(row: Integer; col: Integer; var format: TFormat): TRichString;
var
  richString: RichStringHandle;
begin
...
function TSheet.writeRichStr(row: Integer; col: Integer; value: TRichString): boolean;
begin
  result := xlSheetWriteRichStr(handle, row, col, value.handle, nil) > 0;
end;

function TSheet.writeRichStr(row: Integer; col: Integer; value: TRichString; format: TFormat): boolean;
begin
...
function TSheet.writeNum(row, col: Integer; value: double): boolean;
begin
  result := xlSheetWriteNum(handle, row, col, value, nil) > 0;
end;

function TSheet.writeNum(row, col: Integer; value: double; format: TFormat): boolean;
begin
...
function TSheet.writeBool(row, col: Integer; value: boolean): boolean;
begin
  result := xlSheetWriteBool(handle, row, col, Integer(value), nil) > 0;
end;

function TSheet.writeBool(row, col: Integer; value: boolean; format: TFormat): boolean;
begin
  result := xlSheetWriteBool(handle, row, col, Integer(value), format.handle) > 0;
end;

function TSheet.readBlank(row, col: Integer; var format: TFormat): boolean;
var
  fmtHandle: FormatHandle;
begin
...
function TSheet.writeBlank(row, col: Integer; format: TFormat): boolean;
begin
  result := xlSheetWriteBlank(handle, row, col, format.handle) > 0;
end;

function TSheet.readFormula(row, col: Integer): WideString;
var
  format: FormatHandle;
  s: PWideChar;
begin
...
function TSheet.readFormula(row, col: Integer; var format: TFormat): WideString;
var
  fmtHandle: FormatHandle;
  s: PWideChar;
begin
...
function TSheet.writeFormula(row, col: Integer; value: PWideChar): boolean;
begin
  result := xlSheetWriteFormula(handle, row, col, value, nil) > 0;
end;

function TSheet.writeFormula(row, col: Integer; value: PWideChar; format: TFormat): boolean;
begin
  result := xlSheetWriteFormula(handle, row, col, value, format.handle) > 0;
end;

function TSheet.writeFormulaNum(row, col: Integer; expr: PWideChar; value: double): boolean;
begin
  result := xlSheetWriteFormulaNum(handle, row, col, expr, value, nil) > 0;
end;

function TSheet.writeFormulaNum(row, col: Integer; expr: PWideChar; value: double; format: TFormat): boolean;
begin
  result := xlSheetWriteFormulaNum(handle, row, col, expr, value, format.handle) > 0;
end;

function TSheet.writeFormulaStr(row, col: Integer; expr: PWideChar; value: PWideChar): boolean;
begin
  result := xlSheetWriteFormulaStr(handle, row, col, expr, value, nil) > 0;
end;

function TSheet.writeFormulaStr(row, col: Integer; expr: PWideChar; value: PWideChar; format: TFormat): boolean;
begin
  result := xlSheetWriteFormulaStr(handle, row, col, expr, value, format.handle) > 0;
end;

function TSheet.writeFormulaBool(row, col: Integer; expr: PWideChar; value: Integer): boolean;
begin
  result := xlSheetWriteFormulaBool(handle, row, col, expr, value, nil) > 0;
end;

function TSheet.writeFormulaBool(row, col: Integer; expr: PWideChar; value: Integer; format: TFormat): boolean;
begin
  result := xlSheetWriteFormulaBool(handle, row, col, expr, value, format.handle) > 0;
end;

function TSheet.readComment(row, col: Integer): WideString;
var
  s: PWideChar;
begin
...
procedure TSheet.writeComment(row, col: Integer; value, author: PWideChar; width, height: Integer);
begin
...
function TSheet.isRichStr(row, col: Integer): boolean;
begin
...
function TSheet.setCol(col: Integer; width: double; format: TFormat): boolean;
begin
  result := setCol(col, col, width, format);
end;

function TSheet.setCol(colFirst, colLast: Integer; width: double): boolean;
begin
  result := xlSheetSetCol(handle, colFirst, colLast, width, nil, 0) > 0;
end;

function TSheet.setCol(col: Integer; width: double): boolean;
begin
  result := setCol(col, col, width);
end;

function TSheet.setCol(colFirst, colLast: Integer; width: double; format: TFormat; hidden: boolean): boolean;
var
  fmtHandle: FormatHandle;
begin
  if format <> nil then
...
function TSheet.setCol(col: Integer; width: double; format: TFormat; hidden: boolean): boolean;
begin
  result := setCol(col, col, width, format, hidden);
end;

function TSheet.setCol(colFirst, colLast: Integer; width: double; format: TFormat): boolean;
var
  fmtHandle: FormatHandle;
begin
  if format <> nil then
...
function TSheet.setRow(row: Integer; height: double): boolean;
begin
  result := xlSheetSetRow(handle, row, height, nil, 0) > 0;
end;

function TSheet.setRow(row: Integer; height: double; format: TFormat): boolean;
begin
  result := xlSheetSetRow(handle, row, height, format.handle, 0) > 0;
end;

function TSheet.setRow(row: Integer; height: double; format: TFormat; hidden: boolean): boolean;
var
  fmtHandle: FormatHandle;
begin
  if format <> nil then
...
function TSheet.setRowHidden(row: Integer; hidden: boolean): boolean;
begin
...
function TSheet.setColHidden(col: Integer; hidden: boolean): boolean;
begin
...
function TSheet.delHorPageBreak(row: Integer): boolean;
begin
  result := xlSheetSetHorPageBreak(handle, row, 0) > 0;
end;

function TSheet.delVerPageBreak(col: Integer): boolean;
begin
  result := xlSheetSetVerPageBreak(handle, col, 0) > 0;
end;

function TSheet.setHorPageBreak(row: Integer): boolean;
begin
  result := xlSheetSetHorPageBreak(handle, row, 1) > 0;
end;

function TSheet.setVerPageBreak(col: Integer): boolean;
begin
...
function TSheet.removePictureByIndex(index: Integer): boolean;
begin
  result := xlSheetRemovePictureByIndex(handle, index) > 0;
end;

function TSheet.removePicture(row, col: Integer): boolean;
begin
...
function TSheet.groupCols(colFirst, colLast: Integer; collapsed: boolean): boolean;
begin
  result := xlSheetGroupCols(handle, colFirst, colLast, Integer(collapsed)) > 0;
end;

function TSheet.groupRows(rowFirst, rowLast: Integer; collapsed: boolean): boolean;
begin
  result := xlSheetGroupRows(handle, rowFirst, rowLast, Integer(collapsed)) > 0;
end;

function TSheet.clear(rowFirst, rowLast, colFirst, colLast: Integer): boolean;
begin
  result := xlSheetClear(handle, rowFirst, rowLast, colFirst, colLast) > 0;
end;

function TSheet.insertCol(colFirst, colLast: Integer): boolean;
begin
  result := xlSheetInsertCol(handle, colFirst, colLast) > 0;
end;

function TSheet.insertRow(rowFirst, rowLast: Integer): boolean;
begin
  result := xlSheetInsertRow(handle, rowFirst, rowLast) > 0;
end;

function TSheet.removeCol(colFirst, colLast: Integer): boolean;
begin
  result := xlSheetRemoveCol(handle, colFirst, colLast) > 0;
end;

function TSheet.removeRow(rowFirst, rowLast: Integer): boolean;
begin
  result := xlSheetRemoveRow(handle, rowFirst, rowLast) > 0;
end;

function TSheet.copyCell(rowSrc, colSrc, rowDst, colDst: Integer): boolean;
begin
...
function TSheet.getNamedRange(const name: PWideChar; var rowFirst, rowLast, colFirst, colLast: Integer): boolean;
var
  hidden: boolean;
begin
...
function TSheet.getNamedRange(const name: PWideChar; var rowFirst, rowLast, colFirst, colLast: Integer; scopeId: Integer): boolean;
var
  hidden: boolean;
begin
...
function TSheet.getNamedRange(const name: PWideChar; var rowFirst, rowLast, colFirst, colLast: Integer; scopeId: Integer; var hidden: boolean): boolean;
begin
  result := xlSheetGetNamedRange(handle, name, @rowFirst, @rowLast, @colFirst, @colLast, scopeId, @hidden) > 0;
end;

function TSheet.setNamedRange(const name: PWideChar; rowFirst, rowLast, colFirst, colLast: Integer): boolean;
begin
  result := xlSheetSetNamedRange(handle, name, rowFirst, rowLast, colFirst, colLast, -2) > 0;
end;

function TSheet.setNamedRange(const name: PWideChar; rowFirst, rowLast, colFirst, colLast, scopeId: Integer): boolean;
begin
  result := xlSheetSetNamedRange(handle, name, rowFirst, rowLast, colFirst, colLast, scopeId) > 0;
end;

function TSheet.delNamedRange(const name: PWideChar): boolean;
begin
  result := xlSheetDelNamedRange(handle, name, -2) > 0;
end;

function TSheet.delNamedRange(const name: PWideChar; scopeId: Integer): boolean;
begin
...
function TSheet.namedRange(index: Integer; var rowFirst, rowLast, colFirst, colLast: Integer): WideString;
var
  scopeId: Integer;
  hidden: boolean;
begin
...
function TSheet.table(index: Integer; var rowFirst, rowLast, colFirst, colLast, headerRowCount, totalsRowCount: Integer): WideString;
begin
...
function TSheet.hyperlink(index: Integer; var rowFirst, rowLast, colFirst, colLast: Integer): WideString;
begin
  result := xlSheetHyperlink(handle, index, @rowFirst, @rowLast, @colFirst, @colLast);
end;

function TSheet.delHyperlink(index: Integer): boolean;
begin
  result := xlSheetDelHyperlink(handle, index) > 0;
end;

procedure TSheet.addHyperlink(const hyperlink: PWideChar; rowFirst, rowLast, colFirst, colLast: Integer);
begin
...
procedure TSheet.setProtect(protect: boolean; const password: PWideChar);
begin
  xlSheetSetProtectEx(handle, Integer(protect), password, -1);
end;

procedure TSheet.setProtect(protect: boolean; const password: PWideChar; const prot: EnhancedProtection);
begin
...
function TSheet.Getheader: WideString;
var
  s: PWideChar;
begin
...
procedure TSheet.Setheader(const value: WideString);
var
  PValue: PWideChar;
begin
  PValue := @(value[1]);
...
function TSheet.Getfooter: WideString;
var
  s: PWideChar;
begin
...
procedure TSheet.Setfooter(const value: WideString);
var
  PValue: PWideChar;
begin
  PValue := @(value[1]);
...
function TSheet.Getname: WideString;
var
  s: PWideChar;
begin
...
procedure TSheet.Setname(const value: WideString);
begin
...
procedure TSheet.addrToRowCol(const addr: PWideChar; var row, col: Integer);
begin
  xlSheetAddrToRowCol(handle, addr, @row, @col, nil, nil);
end;

procedure TSheet.addrToRowCol(const addr: PWideChar; var row, col: Integer; var rowRelative, colRelative: boolean);
var
...
function TSheet.rowColToAddr(row, col: Integer): WideString;
var
  s: PWideChar;
begin
...
function TSheet.rowColToAddr(row, col: Integer; rowRelative, colRelative: boolean): WideString;
var
  s: PWideChar;
begin
...
procedure TSheet.addDataValidation(vtype: DataValidationType; op: DataValidationOperator; rowFirst: Integer; rowLast: Integer; colFirst: Integer; colLast: Integer; const value: PWideChar);
begin
  xlSheetAddDataValidation(handle, Integer(vtype), Integer(op), rowFirst, rowLast, colFirst, colLast, value, nil);
end;

procedure TSheet.addDataValidation(vtype: DataValidationType; op: DataValidationOperator; rowFirst: Integer; rowLast: Integer; colFirst: Integer; colLast: Integer; const value1: PWideChar; const value2: PWideChar);
begin
...
function TBook.load(filename: PWideChar): boolean;
begin
  result := xlBookLoad(handle, filename) > 0;
end;

function TBook.save(filename: PWideChar): boolean;
begin
  result := xlBookSave(handle, filename) > 0;
end;

function TBook.loadRaw(data: PByteArray; size: Cardinal): boolean;
begin
  result := xlBookLoadRaw(handle, addr(data^[0]), size) > 0;
end;

function TBook.saveRaw(var Buffer: ByteArray; var size: Cardinal): boolean;
var
  ptr: PByteArray;
  i: Integer;
  p: PByte;
...
function TBook.addSheet(name: PWideChar): TSheet;
var
...
function TBook.addSheet(name: PWideChar; initSheet: TSheet): TSheet;
var
  new_sheetHandle: SheetHandle;
begin
...
function TBook.insertSheet(index: Integer; name: PWideChar): TSheet;
var
  new_sheetHandle: SheetHandle;
begin
...
function TBook.insertSheet(index: Integer; name: PWideChar; initSheet: TSheet): TSheet;
var
  new_sheetHandle: SheetHandle;
begin
...
function TBook.delSheet(index: Integer): boolean;
begin
...
function TBook.addRichString(): TRichString;
var
  richString: RichStringHandle;
begin
...
function TBook.addCustomNumFormat(customNumFormat: PWideChar): Integer;
begin
  result := xlBookAddCustomNumFormat(handle, customNumFormat);
end;

function TBook.customNumFormat(fmt: Integer): WideString;
var  
  s: PWideChar;
begin
...
function TBook.dateUnpack(value: double; var year: Integer; var month: Integer; var day: Integer): boolean;
begin
  result := xlBookDateUnpack(handle, value, addr(year), addr(month), addr(day), nil, nil, nil, nil) > 0;
end;

function TBook.dateUnpack(value: double; var year: Integer; var month: Integer; var day: Integer; var hour: Integer; var min: Integer; var sec: Integer): boolean;
begin
  result := xlBookDateUnpack(handle, value, addr(year), addr(month), addr(day), addr(hour), addr(min), addr(sec), nil) > 0;
end;

function TBook.dateUnpack(value: double; var year: Integer; var month: Integer; var day: Integer; var hour: Integer; var min: Integer; var sec: Integer; var msec: Integer): boolean;
begin
...
function TBook.addPicture(filename: PWideChar): Integer;
begin
...
function TBook.addPictureAsLink(filename: PWideChar; insert: boolean): Integer;
begin
  result := xlBookAddPictureAsLink(handle, filename, Integer(insert));
end;

function TBook.defaultFont(var fontSize: Integer): WideString;
var
  s: PWideChar;
begin
...
procedure TBook.setDefaultFont(fontName: PWideChar; fontSize: Integer);
begin
...
function TBook.calcMode(): CalcModeType;
begin
  result := CalcModeType(xlBookCalcMode(handle));
end;

procedure TBook.setCalcMode(calcMode: CalcModeType);
begin
...
function TBook.setLocale(locale: PWideChar): boolean;
begin
  result := xlBookSetLocale(handle, locale) > 0;
end;


function TBook.errorMessage: WideString;
begin
