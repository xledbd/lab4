///////////////////////////////////////////////////////////////////////////////
//                                                                           //
//                   LibXL Delphi 7 wrapper version 3.9.0                    //
//                                                                           //
...
type
  ...
  public
     ...
     procedure addText(const text: PAnsiChar; font: TFont); overload;
     function getText(index: Integer): AnsiString; overload;
     function getText(index: Integer; var font: TFont): AnsiString; overload;
...
type
  ...
  public
    ...
    function writeStr(row: Integer; col: Integer; value: PAnsiChar; format: TFormat): boolean; overload;
    ...
    function writeFormula(row: Integer; col: Integer; value: PAnsiChar; format: TFormat): boolean; overload;

    function writeFormulaNum(row: Integer; col: Integer; expr: PAnsiChar; value: double): boolean; overload;
    function writeFormulaNum(row: Integer; col: Integer; expr: PAnsiChar; value: double; format: TFormat): boolean; overload;

    function writeFormulaStr(row: Integer; col: Integer; expr: PAnsiChar; value: PAnsiChar): boolean; overload;
    function writeFormulaStr(row: Integer; col: Integer; expr: PAnsiChar; value: PAnsiChar; format: TFormat): boolean; overload;

    function writeFormulaBool(row: Integer; col: Integer; expr: PAnsiChar; value: Integer): boolean; overload;
    function writeFormulaBool(row: Integer; col: Integer; expr: PAnsiChar; value: Integer; format: TFormat): boolean; overload;
...
procedure TRichString.addText(const text: PAnsiChar);
begin
   xlRichStringAddText(handle, text, nil);
end;

procedure TRichString.addText(const text: PAnsiChar; font: TFont);
begin
   xlRichStringAddText(handle, text, font.handle);
end;

function TRichString.getText(index: Integer): AnsiString;
var
   fntHandle: FontHandle;
   s: PAnsiChar;
begin
...
function TRichString.getText(index: Integer; var font: TFont): AnsiString;
var
   fntHandle: FontHandle;
   s: PAnsiChar;
begin
...
begin
  ...
  if format <> nil then
    result := TFormat.Create(format, book)
  else
    result := nil;  
end;
...
function TSheet.writeStr(row, col: Integer; value: PAnsiChar): boolean;
begin
  result := xlSheetWriteStr(handle, row, col, value, nil) > 0;
end;

function TSheet.writeStr(row, col: Integer; value: PAnsiChar; format: TFormat): boolean;
begin
...
function TSheet.writeFormula(row, col: Integer; value: PAnsiChar): boolean;
begin
  result := xlSheetWriteFormula(handle, row, col, value, nil) > 0;
end;

function TSheet.writeFormula(row, col: Integer; value: PAnsiChar; format: TFormat): boolean;
begin
  result := xlSheetWriteFormula(handle, row, col, value, format.handle) > 0;
end;

function TSheet.writeFormulaNum(row, col: Integer; expr: PAnsiChar; value: double): boolean;
begin
  result := xlSheetWriteFormulaNum(handle, row, col, expr, value, nil) > 0;
end;

function TSheet.writeFormulaNum(row, col: Integer; expr: PAnsiChar; value: double; format: TFormat): boolean;
begin
  result := xlSheetWriteFormulaNum(handle, row, col, expr, value, format.handle) > 0;
end;

function TSheet.writeFormulaStr(row, col: Integer; expr: PAnsiChar; value: PAnsiChar): boolean;
begin
  result := xlSheetWriteFormulaStr(handle, row, col, expr, value, nil) > 0;
end;

function TSheet.writeFormulaStr(row, col: Integer; expr: PAnsiChar; value: PAnsiChar; format: TFormat): boolean;
begin
  result := xlSheetWriteFormulaStr(handle, row, col, expr, value, format.handle) > 0;
end;

function TSheet.writeFormulaBool(row, col: Integer; expr: PAnsiChar; value: Integer): boolean;
begin
  result := xlSheetWriteFormulaBool(handle, row, col, expr, value, nil) > 0;
end;

function TSheet.writeFormulaBool(row, col: Integer; expr: PAnsiChar; value: Integer; format: TFormat): boolean;
begin
...
function TSheet.setNamedRange(const name: PAnsiChar; rowFirst, rowLast, colFirst, colLast: Integer): boolean;
begin
  result := xlSheetSetNamedRange(handle, name, rowFirst, rowLast, colFirst, colLast, -2) > 0;
end;

function TSheet.setNamedRange(const name: PAnsiChar; rowFirst, rowLast, colFirst, colLast, scopeId: Integer): boolean;
begin
  result := xlSheetSetNamedRange(handle, name, rowFirst, rowLast, colFirst, colLast, scopeId) > 0;
end;

function TSheet.delNamedRange(const name: PAnsiChar): boolean;
begin
  result := xlSheetDelNamedRange(handle, name, -2) > 0;
end;

function TSheet.delNamedRange(const name: PAnsiChar; scopeId: Integer): boolean;
begin
...
function TBook.load(filename: PAnsiChar): boolean;
begin
  result := xlBookLoad(handle, filename) > 0;
end;

function TBook.save(filename: PAnsiChar): boolean;
begin
...
function TBook.setLocale(locale: PAnsiChar): boolean;
begin
